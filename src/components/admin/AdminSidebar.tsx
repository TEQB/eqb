...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 8.25h9m-9 3h6m-9 7.5 3.75-3.75H18a2.25 2.25 0 002.25-2.25v-9A2.25 2.25 0 0018 1.5H6A2.25 2.25 0 003.75 3.75v14.25z" />
      </svg>
    ),
  },
  {
